...
public class EquipmentServiceTest {
    ...
    private final transient long equipmentId = 0L;
    private final transient String name = "boxingGloves";
    private final transient boolean inUse = true;
    private transient Sport kickboxing = new Sport("kickbox", false, 1, -1);
    private final transient Sport relatedSport = kickboxing;
    ...
    public void getEquipmentTest() throws NoSuchFieldException {
        Mockito.when(equipmentRepository.findByEquipmentId(equipmentId))
            .thenReturn(new Equipment(name, relatedSport, inUse));
    ...
    public void setEquipmentToNotInUseTest() throws NoSuchFieldException {
        Mockito.when(equipmentRepository.findByEquipmentId(equipmentId))
            .thenReturn(new Equipment(name, relatedSport, true));
    ...
    public void setEquipmentToInUseTest() throws NoSuchFieldException {
        Mockito.when(equipmentRepository.findByEquipmentId(equipmentId))
            .thenReturn(new Equipment(name, relatedSport, false));
    ...
    public void getAvailableEquipmentIdsByNameTest() throws NoSuchFieldException {
        ...
        Mockito.when(equipmentRepository.findAvailableEquipment(name))
            .thenReturn(java.util.Optional.of(equipmentId));
    ...
    public void addEquipmentTest() {
        ...
        assertEquals(equipment2, equipmentRepository.findByEquipmentId(1L));
    }
