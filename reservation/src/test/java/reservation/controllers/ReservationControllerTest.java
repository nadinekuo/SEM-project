...
public class ReservationControllerTest {
    ...
    private final transient LocalDateTime bookableDate =
    ...
    //        mockMvc.perform(post("/reservation/{userId}/{equipmentName}/{date
    //        }/makeEquipmentBooking",
    //                userId,
    //                equipmentName, validDate))
    //            .andExpect(status().isOk())
    //            .andExpect((ResultMatcher) content().string(containsString("Equipment
    //            reservation "
    //            + "was successful!")));
    ...
    //            //.andExpect((ResultMatcher) content().string(containsString("Date and time has
    //            to be "
    //            //+ "after now")))
