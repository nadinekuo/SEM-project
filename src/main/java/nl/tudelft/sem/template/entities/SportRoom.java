...
public class SportRoom {
    ...
    @OneToMany(mappedBy = "sportRoomReserved", fetch = FetchType.LAZY, cascade =
        CascadeType.REMOVE)
    @JsonManagedReference
    private List<Reservation> reservationsForRoom;
    ...
    public void setReservationsForRoom(List<Reservation> reservationsForRoom) {
        this.reservationsForRoom = reservationsForRoom;
    }
